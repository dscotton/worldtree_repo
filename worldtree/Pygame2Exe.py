...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "worldtree.py"
 
        #Name of program
        self.project_name = "World Tree"
        ...
        #Auhor of program
        self.author_name = "David Scotton"
        self.author_email = "dscotton@gmail.com"
        self.copyright = "Copyright (c) 2012 David Scotton."
 
        #Description
        self.project_description = "World Tree Game"
...
if __name__ == '__main__':
    ...
    eval(input("Press any key to continue")) #Pause to let user see that things ends